package com.project.EStore.validation;
...
import static com.project.EStore.service.product.ProductService.HIGHEST_PRICE;
...
public class ProductValidator {
    ...
    public boolean isCategoryTypeValid(String category) {
        try {
